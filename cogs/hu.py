import asyncio
mensagens = ["Não pode falar um "A" aqui que é ban, KKKKKKKKKKK por isso que tá falido aí, server de merda, Morgan é outro fudidozinho que nunca vai crescer, com pc de 100k de reais e edita uma bosta, eu edito mais que ele pelo AM
...
print(f"Enviadas {len(mensagens)} mensagens.")
